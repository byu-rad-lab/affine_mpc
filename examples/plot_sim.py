...
def main():
    ...
    time = np.loadtxt(f'{save_dir}/time.txt')
    states = np.loadtxt(f'{save_dir}/states.txt')
    ref_states = np.loadtxt(f'{save_dir}/ref_states.txt')
    inputs = np.loadtxt(f'{save_dir}/inputs.txt')
    solve_times = np.loadtxt(f'{save_dir}/solve_times.txt')
