...
find_package(pybind11 ${PYBIND11_VER} QUIET) # known to work with versions 2.4.3 - 2.9.2
...
if (${pybind11_FOUND})
  ...
  message(STATUS "System install of Pybind11 not found - getting Pybind11")
  FetchContent_Declare(pybind11_extern
    GIT_REPOSITORY https://github.com/pybind/pybind11
    GIT_TAG v${PYBIND11_VER}
  )
  FetchContent_MakeAvailable(pybind11_extern)
  message(STATUS "Pybind11 version: ${PYBIND11_VER}") # should match GIT_TAG above
endif()
